 ...
 *
 * Note: the Mollie return / thank-you flow lives in backend-voucher-thanks.js
 * (initBackendVoucherThanks) and the invoice request in backend-voucher-invoice.js
 * (initBackendVoucherInvoice); both are wired up in maakbon-main.js.
 */
